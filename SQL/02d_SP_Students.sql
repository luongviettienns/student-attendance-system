...
-- 02d_SP_Students.sql
-- ===========================================
-- Description: Students Management SPs
...
PRINT '========================================';
PRINT 'Starting: 02d_SP_Students.sql';
PRINT '========================================';
GO
...
PRINT '[OK] Students Management SPs created';
GO
...
PRINT '[OK] Students Management SPs completed';
GO
...
-- ===========================================
-- SP: sp_AddStudentFull - Create Student from existing UserId
-- ===========================================
