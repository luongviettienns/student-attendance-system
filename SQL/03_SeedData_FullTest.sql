...
USING (VALUES
    ('ROLE_ADMIN',    N'Admin',             N'Quan tri he thong',          1),
    ('ROLE_LECTURER', N'Lecturer',         N'Giang vien giang day',       1),
    ('ROLE_STUDENT',  N'Student',          N'Sinh vien',                  1),
    ('ROLE_ADVISOR',  N'Advisor',          N'Co van hoc tap',             1),
    ('ROLE_SUPPORT',  N'Academic Support', N'Nhan vien phong dao tao',    1)
...
USING (VALUES
    ...
    ('USR_SUPPORT_FT','support_academic',   '$2a$10$Ya6MFL1CGpg2/y088u6t7.ACYkMJdmA1869rbBmAnyn6OQi0hTBue', 'support.academic@example.com','0901000001', N'Tran Hoai Thu',               'ROLE_SUPPORT', 1),
...
USING (VALUES
    ('PERM_STU_OVERVIEW', 'STUDENT_SECTION_OVERVIEW', N'Tong quan',          NULL,                     'fas fa-home',              1, N'Menu tong quan cho sinh vien',                1),
    ('PERM_STU_STUDY',    'STUDENT_SECTION_STUDY',    N'Hoc tap',             NULL,                     'fas fa-book',              2, N'Menu hoc tap cho sinh vien',                  1),
    ('PERM_STU_PROFILE',  'STUDENT_SECTION_PROFILE',  N'Ca nhan',             NULL,                     'fas fa-user',              3, N'Menu ca nhan',                                1),
    ('PERM_STU_SYSTEM',   'STUDENT_SECTION_SYSTEM',   N'He thong',            NULL,                     'fas fa-cog',               4, N'Menu he thong',                               1),
    ('PERM_STU_DASHBOARD','STUDENT_DASHBOARD',        N'Dashboard',           'STUDENT_SECTION_OVERVIEW','fas fa-tachometer-alt',   1, N'Dashboard sinh vien',                         1),
    ('PERM_STU_TIMETABLE','STUDENT_TIMETABLE',        N'Thoi khoa bieu',      'STUDENT_SECTION_STUDY',  'fas fa-calendar-alt',     1, N'Xem thoi khoa bieu',                          1),
    ('PERM_STU_SCHEDULE', 'STUDENT_SCHEDULE',         N'Lich hoc',            'STUDENT_SECTION_STUDY',  'fas fa-calendar',         2, N'Xem lich hoc',                                 1),
    ('PERM_STU_GRADES',   'STUDENT_GRADES',           N'Ket qua hoc tap',     'STUDENT_SECTION_STUDY',  'fas fa-graduation-cap',   3, N'Xem bang diem',                                1),
    ('PERM_STU_ATTENDANCE','STUDENT_ATTENDANCE',      N'Diem danh',           'STUDENT_SECTION_STUDY',  'fas fa-clipboard-check',  4, N'Xem lich su diem danh',                        1),
    ('PERM_STU_ENROLLMENT','STUDENT_ENROLLMENT',      N'Dang ky hoc phan',    'STUDENT_SECTION_STUDY',  'fas fa-edit',             5, N'Dang ky hoc phan',                             1),
    ('PERM_STU_PROFILE_ITEM','STUDENT_PROFILE',       N'Thong tin ca nhan',   'STUDENT_SECTION_PROFILE','fas fa-user',             1, N'Quan ly thong tin',                            1),
    ('PERM_STU_REPORTS',  'STUDENT_REPORTS',          N'Thong ke hoc tap',    'STUDENT_SECTION_STUDY',  'fas fa-chart-bar',        6, N'Xem thong ke',                                 1),
    ('PERM_STU_NOTIFICATIONS','STUDENT_NOTIFICATIONS',N'Thong bao',           'STUDENT_SECTION_SYSTEM', 'fas fa-bell',             1, N'Nhan thong bao',                               1),
    ('PERM_STU_APPEALS',  'STUDENT_APPEALS',          N'Phuc khao',           'STUDENT_SECTION_STUDY',  'fas fa-gavel',            7, N'Gui phuc khao',                                 1),
    ('PERM_TCH_OVERVIEW', 'TEACHER_SECTION_OVERVIEW', N'Tong quan',           NULL,                     'fas fa-home',             1, N'Menu tong quan cho giang vien',               1),
    ('PERM_TCH_TEACHING', 'TEACHER_SECTION_TEACHING', N'Giang day',           NULL,                     'fas fa-chalkboard-teacher',2,N'Menu giang day',                                1),
    ('PERM_TCH_SYSTEM',   'TEACHER_SECTION_SYSTEM',   N'He thong',            NULL,                     'fas fa-cog',              3, N'Menu he thong giang vien',                    1),
    ('PERM_TCH_DASHBOARD','TEACHER_DASHBOARD',        N'Dashboard',           'TEACHER_SECTION_OVERVIEW','fas fa-tachometer-alt',  1, N'Dashboard giang vien',                        1),
    ('PERM_TCH_ATTENDANCE','TEACHER_ATTENDANCE',      N'Diem danh',           'TEACHER_SECTION_TEACHING','fas fa-check-square',   1, N'Diem danh sinh vien',                         1),
    ('PERM_TCH_GRADES',   'TEACHER_GRADES',           N'Nhap diem',           'TEACHER_SECTION_TEACHING','fas fa-graduation-cap', 2, N'Nhap diem',                                     1),
    ('PERM_TCH_TIMETABLE','TEACHER_TIMETABLE',        N'Thoi khoa bieu',      'TEACHER_SECTION_TEACHING','fas fa-calendar-alt',   3, N'Lich giang day',                               1),
    ('PERM_TCH_REPORTS',  'TEACHER_REPORTS',          N'Thong ke lop',        'TEACHER_SECTION_TEACHING','fas fa-chart-line',     4, N'Thong ke lop',                                1),
    ('PERM_TCH_NOTIFICATIONS','TEACHER_NOTIFICATIONS',N'Thong bao',           'TEACHER_SECTION_SYSTEM', 'fas fa-bell',            1, N'Thong bao he thong',                           1),
    ('PERM_TCH_GRADE_FORMULA','TEACHER_GRADE_FORMULA',N'Cong thuc diem',      'TEACHER_SECTION_TEACHING','fas fa-equals',        5, N'Quan ly cong thuc diem lop day',               1),
    ('PERM_ADV_OVERVIEW', 'ADVISOR_SECTION_OVERVIEW', N'Tong quan',           NULL,                     'fas fa-home',            1, N'Menu tong quan co van',                        1),
    ('PERM_ADV_ADVISING', 'ADVISOR_SECTION_ADVISING', N'Co van',              NULL,                     'fas fa-user-graduate',   2, N'Menu cong viec co van',                        1),
    ('PERM_ADV_SYSTEM',   'ADVISOR_SECTION_SYSTEM',   N'He thong',            NULL,                     'fas fa-cog',             3, N'Menu he thong co van',                        1),
    ('PERM_ADV_DASHBOARD','ADVISOR_DASHBOARD',        N'Dashboard',           'ADVISOR_SECTION_OVERVIEW','fas fa-tachometer-alt', 1, N'Dashboard co van',                            1),
    ('PERM_ADV_STUDENTS', 'ADVISOR_STUDENTS',         N'Sinh vien',           'ADVISOR_SECTION_ADVISING','fas fa-user-graduate', 1, N'Quan ly sinh vien duoc phan cong',             1),
    ('PERM_ADV_WARNINGS', 'ADVISOR_WARNINGS',         N'Canh bao',            'ADVISOR_SECTION_ADVISING','fas fa-exclamation-triangle',2,N'Quan ly canh bao',                         1),
    ('PERM_ADV_APPEALS',  'ADVISOR_APPEALS',          N'Phuc khao',           'ADVISOR_SECTION_ADVISING','fas fa-gavel',          3, N'Duyet phuc khao',                             1),
    ('PERM_ADV_GRADE_FORMULA','ADVISOR_GRADE_FORMULA',N'Cong thuc diem',      'ADVISOR_SECTION_ADVISING','fas fa-calculator',    4, N'Quan ly cong thuc diem',                      1),
    ('PERM_ADV_ENROLLMENTS','ADVISOR_ENROLLMENTS',    N'Duyet dang ky',       'ADVISOR_SECTION_ADVISING','fas fa-clipboard-check',5,N'Duyet dang ky',                               1),
    ('PERM_ADV_REPORTS',  'ADVISOR_REPORTS',          N'Thong ke',            'ADVISOR_SECTION_ADVISING','fas fa-chart-pie',      6, N'Bao cao',                                      1),
    ('PERM_ADV_NOTIFICATIONS','ADVISOR_NOTIFICATIONS',N'Thong bao',           'ADVISOR_SECTION_SYSTEM', 'fas fa-bell',           1, N'Nhan thong bao',                              1),
    ('PERM_ADV_RETAKE',   'ADVISOR_RETAKE',           N'Quan ly hoc lai',     'ADVISOR_SECTION_ADVISING','fas fa-history',       7, N'Quan ly ho so hoc lai',                       1),
    ('PERM_ADM_OVERVIEW', 'ADMIN_SECTION_OVERVIEW',   N'Tong quan',           NULL,                     'fas fa-home',           1, N'Menu tong quan admin',                        1),
    ('PERM_ADM_USERS',    'ADMIN_SECTION_USERS',      N'Quan ly nguoi dung',  NULL,                     'fas fa-users',          2, N'Menu nguoi dung',                              1),
    ('PERM_ADM_ACADEMIC', 'ADMIN_SECTION_ACADEMIC',   N'Quan ly dao tao',     NULL,                     'fas fa-graduation-cap', 3, N'Menu dao tao',                                  1),
    ('PERM_ADM_SUBJECTS', 'ADMIN_SECTION_SUBJECTS',   N'Hoc phan',            NULL,                     'fas fa-book',           4, N'Menu hoc phan',                               1),
    ('PERM_ADM_ADMIN_CLASSES_SECTION','ADMIN_SECTION_CLASSES', N'Lop hanh chinh', NULL,                 'fas fa-users-class',     5, N'Menu lop hanh chinh',                        1),
    ('PERM_ADM_ENROLLMENT','ADMIN_SECTION_ENROLLMENT',N'Dang ky hoc phan',    NULL,                     'fas fa-clipboard-list', 6, N'Menu dang ky',                                 1),
    ('PERM_ADM_TIMETABLE','ADMIN_SECTION_TIMETABLE',  N'Quan ly thoi khoa bieu',NULL,                   'fas fa-calendar-alt',    7, N'Menu thoi khoa bieu',                         1),
    ('PERM_ADM_SYSTEM',   'ADMIN_SECTION_SYSTEM',     N'He thong',            NULL,                     'fas fa-cog',            8, N'Menu he thong',                               1),
    ('PERM_ADM_DASHBOARD','ADMIN_DASHBOARD',          N'Dashboard',           'ADMIN_SECTION_OVERVIEW', 'fas fa-tachometer-alt', 1, N'Dashboard admin',                              1),
    ('PERM_ADM_USERS_ITEM','ADMIN_USERS',             N'Tai khoan',           'ADMIN_SECTION_USERS',    'fas fa-users',          1, N'Quan ly tai khoan',                           1),
    ('PERM_ADM_ROLES',    'ADMIN_ROLES',              N'Vai tro & quyen',     'ADMIN_SECTION_USERS',    'fas fa-shield-alt',     2, N'Quan ly vai tro',                             1),
    ('PERM_ADM_ORGANIZATION','ADMIN_ORGANIZATION',    N'Quan ly to chuc',     'ADMIN_SECTION_ACADEMIC', 'fas fa-sitemap',        1, N'Quan ly khoa, bo mon',                       1),
    ('PERM_ADM_STUDENTS', 'ADMIN_STUDENTS',           N'Sinh vien',           'ADMIN_SECTION_ACADEMIC', 'fas fa-user-graduate',  2, N'Quan ly sinh vien',                            1),
    ('PERM_ADM_LECTURERS','ADMIN_LECTURERS',          N'Giang vien',          'ADMIN_SECTION_ACADEMIC', 'fas fa-chalkboard-teacher',3,N'Quan ly giang vien',                      1),
    ('PERM_ADM_ACADEMIC_YEARS','ADMIN_ACADEMIC_YEARS',N'Nien khoa',           'ADMIN_SECTION_ACADEMIC', 'fas fa-calendar-alt',   4, N'Quan ly nien khoa',                           1),
    ('PERM_ADM_SCHOOL_YEARS','ADMIN_SCHOOL_YEARS',    N'Nam hoc',             'ADMIN_SECTION_ACADEMIC', 'fas fa-calendar-check', 5, N'Quan ly nam hoc',                              1),
    ('PERM_ADM_GRADE_FORMULA','ADMIN_GRADE_FORMULA',  N'Cong thuc diem',      'ADMIN_SECTION_ACADEMIC', 'fas fa-calculator',     6, N'Quan ly cong thuc diem',                      1),
    ('PERM_ADM_SUBJECT_PREREQUISITES','ADMIN_SUBJECT_PREREQUISITES', N'Tien quyet','ADMIN_SECTION_SUBJECTS','fas fa-project-diagram',1,N'Quan ly tien quyet',                       1),
    ('PERM_ADM_CLASSES',  'ADMIN_CLASSES',            N'Lop hoc phan',        'ADMIN_SECTION_SUBJECTS', 'fas fa-chalkboard',     2, N'Quan ly lop hoc phan',                        1),
    ('PERM_ADM_ADMIN_CLASSES','ADMIN_ADMIN_CLASSES',  N'Lop hanh chinh',      'ADMIN_SECTION_CLASSES',  'fas fa-users-class',    1, N'Quan ly lop hanh chinh',                      1),
    ('PERM_ADM_REGISTRATION_PERIODS','ADMIN_REGISTRATION_PERIODS', N'Dot dang ky','ADMIN_SECTION_ENROLLMENT','fas fa-clock',1,N'Quan ly dot dang ky',                          1),
    ('PERM_ADM_ENROLLMENTS','ADMIN_ENROLLMENTS',      N'Quan ly dang ky',     'ADMIN_SECTION_ENROLLMENT','fas fa-clipboard-list',2,N'Duyet dang ky',                               1),
    ('PERM_ADM_TIMETABLE_ITEM','ADMIN_TIMETABLE',     N'Xep lich',            'ADMIN_SECTION_TIMETABLE','fas fa-calendar-alt',  1, N'Quan ly thoi khoa bieu',                       1),
    ('PERM_ADM_REPORTS',  'ADMIN_REPORTS',            N'Thong ke & Bao cao',  'ADMIN_SECTION_SYSTEM',   'fas fa-chart-bar',      3, N'Thong ke he thong',                           1),
    ('PERM_ADM_AUDIT_LOGS','ADMIN_AUDIT_LOGS',        N'Nhat ky he thong',    'ADMIN_SECTION_SYSTEM',   'fas fa-history',        1, N'Xem nhat ky',                                 1),
    ('PERM_ADM_NOTIFICATIONS','ADMIN_NOTIFICATIONS',  N'Thong bao',           'ADMIN_SECTION_SYSTEM',   'fas fa-bell',           2, N'Quan ly thong bao',                           1)
...
USING (VALUES
    ...
    ('ROLE_SUPPORT','PERM_ADM_OVERVIEW'),
    ('ROLE_SUPPORT','PERM_ADM_DASHBOARD'),
    ('ROLE_SUPPORT','PERM_ADM_ENROLLMENT'),
    ('ROLE_SUPPORT','PERM_ADM_REGISTRATION_PERIODS'),
    ('ROLE_SUPPORT','PERM_ADM_ENROLLMENTS'),
    ('ROLE_SUPPORT','PERM_ADM_REPORTS'),
    ('ROLE_SUPPORT','PERM_ADM_SYSTEM'),
    ('ROLE_SUPPORT','PERM_ADM_AUDIT_LOGS'),
    ('ROLE_SUPPORT','PERM_ADM_NOTIFICATIONS'),
    ('ROLE_SUPPORT','PERM_ADM_GRADE_FORMULA')
